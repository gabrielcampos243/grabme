...
p5 = Partner.create(name: joao.username, description: "charming, strong", price: 1, user_id: joao.id)
p5.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
p5.save
puts "5"
...
p6 = Partner.create(name: daniel.username, description: "charming, strong", price: 10, user_id: daniel.id)
p6.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
p6.save
puts "6"
...
p7 = Partner.create(name: alex.username, description: "charming, strong", price: 100, user_id: alex.id)
p7.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
p7.save
puts "7"
...
p8 = Partner.create(name: rafa.username, description: "charming, strong", price: 100, user_id: rafa.id)
p8.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
p8.save
puts "8"
...
p9 = Partner.create(name: fabio.username, description: "charming, strong", price: 100, user_id: fabio.id)
p9.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
p9.save
puts "9"

file = URI.open("https://res.cloudinary.com/dluisdviu/image/upload/v1661509697/Grab_me/luca_rkmw4s.jpg")
luca = User.create(email: "luca@gmail.com", username: "Luca", password: "123123")
p10 = Partner.create(name: luca.username, description: "charming, strong", price: 100, user_id: luca.id)
p10.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
p10.save
puts "10"
